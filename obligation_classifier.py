...
tokenizer = AutoTokenizer.from_pretrained("lejzi/obligation_classifier")
loaded = AutoModelForSequenceClassification.from_pretrained("lejzi/obligation_classifier")
loaded.to(device)
